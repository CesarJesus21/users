...
import mx.com.jcesar.user.service.UserRoleService;
...
public class UserRoleController {
    ...
    public ResponseEntity get(@RequestParam HashMap<String, String> params, Pageable pageable){
        return this.userRoleService.get(params, pageable);
    }

    @PostMapping
    public ResponseEntity create(@RequestBody UserRoleEntity userRoleEntity){
        return this.userRoleService.create(userRoleEntity);
    }

    @PutMapping("/{id}")
    public ResponseEntity update(@PathVariable("id") String id, @RequestBody Map<String, String> entity){
        return this.userRoleService.update(id, entity);
    }
